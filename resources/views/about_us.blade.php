@extends('layouts.app')
	...
	@section('content')
		...
		<div class="col-12 col-sm-8 ml-auto align-self-center">

			<h2 class="white-text text-center m-0 p-5" style=" font-family: 'Felipa', cursive; text-shadow: 2px 1px 5px #304e4e; font-size: 275%;"><b>About Us</b></h2>

			<h2 class="underline white-text d-none">About Us</h2>
