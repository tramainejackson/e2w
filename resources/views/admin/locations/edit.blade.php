...
@section('content')
    ...
    <div class="col-12 px-5">
        ...
        <form id="" class="locationEditForm" action="/location/{{ $showLocation->id }}" method="POST"
            ...
            <div class="tripLocationContent">
                ...
                <div class="trip_edit_div">
                    ...
                    {{--Trip Image--}}
                    <img src="{{ $showLocation->trip_photo != null ? asset('storage/' . str_ireplace('public/', '', $showLocation->trip_photo)) : '/images/skyline.jpg' }}"
