    ...
    <div class="showTrip col-12 px-0 {{ Auth::check() ? 'mt-n5' : 'mt-5' }}"
        ...
        <div class="col pt-4 rgba-stylish-strong">
            ...
            <div class="container-fluid text-light position-relative" style="z-index:1;">
                                ...
                                <div class="col">
                                    <div id="page_terms_and_conditions">
                                        <p class="terms depositDate text-center" id="">Deposit is Due No Later Than
                                            <span class="text-warning">{{ $tripLocation->deposit_date != null ? $tripLocation->deposit_date->format('m/d/Y') : 'TBA' }}</span>
                                        </p>
                                    </div>
                                </div>
                ...
                <div class="row mx-auto progress-bar progress-bar-striped bg-info black-text py-5 rounded mt-2 flex-row">
                    ...
                    <div class="col-12">
                        <h3 class="text-center text-wrap">If you have any further questions in regards to this trip or any
                        ...
                        <div class="card h-100" id="">
                            <div class="card-body">
                                ...
                                <p class="contact_email mb-1"><span class="font-weight-bold font-italic">Email:</span>&nbsp;<span><a
                                                href="mailto:jacksond1961@yahoo.com" class="">jacksond1961@yahoo.com</a></span>
                                </p>
            ...
            <div class="container-fluid position-relative pt-2 pb-4 mt-5" style="z-index:1;">
                ...
                <div class="row">
                    ...
                    <div class="page_signup_form col-12 col-md-8 py-1 mx-auto">
                        ...
                        <form class="signupForm" id="" action="{{ action('ContactController@store') }}" method="POST"
