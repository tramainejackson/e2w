<div id="navi">
	<ul id="navi_list">
		<li>
			<a href="{{ route('location.index') }}" id="" class="navi_option" {{ isset($_GET["edit_trip"]) || isset($_GET["locations"]) ? "style='font-weight:700; color:#8fba82;'" : "" }} >Trip Locations</a>
			<ul>
		...
		<li>
			<a href="{{ route('pictures.index') }}" id="" class="navi_option" {{ $_SERVER["SCRIPT_NAME"] == "/e2w/admin/pictures.php" && !isset($_GET["add_pictures"]) && !isset($_GET["remove_pictures"]) ? "style='font-weight:700; color:#8fba82;'" : "" }} >Trip Pictures</a>
			<ul>
		...
		<li>
			<a href="{{ route('admin.index') }}" id="" class="navi_option" {{ isset($_GET["admin"]) ? "style='font-weight:700; color:#8fba82;'" : "" }} >Users</a>
			<ul>
