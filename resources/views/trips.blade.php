@extends('layouts.app')
	...
	@section('content')
			...
			<div class="col-12 col-md-6 px-0 mx-auto" id="">
				...
				@else
					<div class="text-center my-5" id="">
						<h1 class="">We do not have any upcoming trips scheduled right now. Please check with us to find out if we have any plans for future vacation or give us some ideas.</h1>
					</div>
				@endif
			</div>
		</div>
		...
		<div class="col-12 px-0 mt-5 mx-auto" id="">
			...
			@else
				<div class="text-center my-5" id="">
					<h1 class="">We do not have any past trips yet. Hopefully we'll get going somewhere soon because I know I need a vacation.</h1>
				</div>
			@endif
		</div>
