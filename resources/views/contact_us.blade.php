				...
				<div class="col-11 col-sm-9 col-lg-6 col-xl-4 mb-2 mx-auto mx-sm-0">
					<div class="card mx-auto h-100" id="">
						...
						<div class="card-body">
							...
							<p class="contact_email"><span class="font-weight-bold font-italic">Phone:</span>&nbsp;<span>215-472-6036 (EST)</span></p>
						</div>
						...
						<div class="card-body">
							...
							<p class="contact_email"><span class="font-weight-bold font-italic">Phone:</span>&nbsp;<span>707-208-7290 (PST)</span></p>
						</div>
					</div>
